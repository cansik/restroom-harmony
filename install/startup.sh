...
# sudo echo "@sh /home/pi/restroom-harmony-master/run.sh" >> /etc/xdg/lxsession/LXDE/autostart
...
sudo chmod -R 777 /home/pi/restroom-harmony-master

# recreate file access
sudo chmod +x /home/pi/restroom-harmony-master/*.sh
sudo chmod +x /home/pi/restroom-harmony-master/install/*.sh